...
static u1 u1g_bridge_ride_mode = 0;
static u1 u1g_bridge_go_mode = 0;
static u1 u1g_bridge_forward_mode = 0;
...
void bridge_ride( Command* cmd , ROBOT_STATUS* status )
{
  ...
  /* user logic start */
    ...
    display_clear(0);
    display_goto_xy(0, 0);  display_string("stage");  display_unsigned(u1g_bridge_ride_mode,3);
//    display_goto_xy(0, 1);  display_string("distance");  display_unsigned(s4t_distance_pair,3);
    ...
    if ( u1s_2msflipcount_bridge == 1 )
    {
        ...
        switch(u1g_bridge_ride_mode){       /* シーソーシーケンス開始 */
   
            case 0 :  /* 開始 */

                f4t_forward = 0;
                u1g_bridge_ride_mode++;
            ...
            case 2:            
                ...
                if(status->lightval > GRAY_WHITE - 20){
            ...
            case 3:
                ...
                if(s4t_distance_bridge < 100){
                    
                    left = 40;
                    right = 40;
                    chokushin();
                    
                }else if(s4t_distance_bridge < 570){
...
void bridge_go( Command* cmd , ROBOT_STATUS* status )
{
  ...
  /* user logic start */
    ...
    display_clear(0);
    display_goto_xy(0, 0);  display_string("stage");  display_unsigned(u1g_bridge_go_mode,3);
//    display_goto_xy(0, 1);  display_string("distance");  display_unsigned(s4t_distance_pair,3);
    ...
    if ( u1s_2msflipcount_bridge == 1 )
    {
        ...
        switch(u1g_bridge_go_mode){       /* シーソーシーケンス開始 */
            ...
            case 3:
                ...
                }else if(s4t_distance_bridge < 550){
                    
                    trace_bridge = 1;                
                    f4t_forward = 20;

                }else if(s4t_distance_bridge < 650){
...
void bridge_forward_pair( Command* cmd , ROBOT_STATUS* status )
{
  ...
  /* user logic start */
    ...
    display_clear(0);
    display_goto_xy(0, 0);  display_string("stage");  display_unsigned(u1g_bridge_forward_mode,3);
    display_goto_xy(0, 1);  display_string("distance");  display_unsigned(s4t_distance_pair,3);
    ...
    if ( u1s_2msflipcount_for == 1 )
    {
        ...
        switch(u1g_bridge_forward_mode)       /* シーソーシーケンス開始 */
        {
            case 0 :  /* 開始 */
        
                left  = 0;
                right = 0;
                u1g_bridge_forward_mode++;
...
int
u4g_dispatch_func_bridge_ride(void)
{
    return u1g_bridge_ride_mode;
}

int
u4g_dispatch_func_bridge_go(void)
{
    return u1g_bridge_go_mode;
}
